...
def main():
 ...
 check("X-Test-Session-Id" in search and "test:person:investigations" in search,"person investigation Test routing is isolated")
 ...
 check(r"CCTV_EMAIL=\${CCTV_EMAIL:?CCTV_EMAIL must be supplied}" in compose and r"CCTV_PASSWORD=\${CCTV_PASSWORD:?CCTV_PASSWORD must be supplied}" in compose,"Compose requires CCTV credentials")
