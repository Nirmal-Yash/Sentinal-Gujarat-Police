...
const button = { width: '100%', marginTop: 18, padding: '9px', border: 0, borderRadius: 5, background: 'var(--accent)', color: 'var(--on-accent)', fontWeight: 800 }
