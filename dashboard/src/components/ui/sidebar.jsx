...
export function SidebarGroupLabel({children}){return <div className="ui-sidebar-group-label" style={{padding:'0 9px 8px',color:'var(--muted)',fontSize:11,fontWeight:850,textTransform:'uppercase',letterSpacing:'1.1px',lineHeight:1.2}}>{children}</div>}
